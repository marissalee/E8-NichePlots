...
#LIBRARIES
library(coefplot) #for mixed-effects coefficent plots
...
#summary(modT.nitrif)
coefplot(modT.nitrif, varnames=longnames, intercept=FALSE, main="Nitrif. (inv-ref) 0-5cm")
...
#summary(modB.nitrif)
coefplot(modB.nitrif, varnames=longnames, intercept=FALSE, main="Nitrif. (inv-ref) 5-15cm")
```
...
modT.minzd<-lmer(Diff_minzd_T ~ 
                    ...
                    (1|year), data=data.q2.modif1_T)
#summary(modT.minzd)
coefplot(modT.minzd, varnames=longnames, intercept=FALSE, main="Minz. (inv-ref) 0-5cm")
...
modB.minzd<-lmer(Diff_minzd_B ~ 
                    ...
                    (1|year), data=data.q2.modif1_B)
#summary(modB.minzd)
coefplot(modB.minzd, varnames=longnames, intercept=FALSE, main="Minz. (inv-ref) 5-15cm")
```
...
modT.noi<-lmer(Diff_noi_T ~ 
                    ...
                    (1|year), data=data.q2.modif1_T)
#summary(modT.minzd)
coefplot(modT.noi, varnames=longnames, intercept=FALSE, main="NO3 (inv-ref) 0-5cm")
...
modB.noi<-lmer(Diff_noi_B ~ 
                    ...
                    (1|year), data=data.q2.modif1_B)
#summary(modB.minzd)
coefplot(modB.noi, varnames=longnames, intercept=FALSE, main="NO3 (inv-ref) 5-15cm")
```
...
modT.ammonifd<-lmer(Diff_ammonifd_T ~ 
                    ...
                    (1|year), data=data.q2.modif1_T)
#summary(modT.minzd)
coefplot(modT.ammonifd, varnames=longnames, intercept=FALSE, main="Ammonif. (inv-ref) 0-5cm")
...
modB.ammonifd<-lmer(Diff_ammonifd_B ~ 
                    ...
                    (1|year), data=data.q2.modif1_B)
#summary(modB.minzd)
coefplot(modB.ammonifd, varnames=longnames, intercept=FALSE, main="Ammonif. (inv-ref) 5-15cm")
```
