...
paste('Differences in nitrate in 0-5cm depths are not mediated by factors measured')
...
write.table(result.mod[['summ']], file=paste(figuresPath,newfilename, sep='/'), sep='\t')
paste('Differences in nitrification in 0-5cm are mediated by (a) PC1, (b) PC2, (c) Myc, (d) Mv, (e) PC1:Myc, (f) PC2:Myc, (g) PC1:Mv, (h) PC2:Mv, (i) Myc:Mv, (j) PC1:Myc:Mv, (k) PC2:Myc:Mv')
#one-way
ggplot(df.mod, aes(x=PC1, y=select.diffVarT))+ geom_point() + mytheme
ggplot(df.mod, aes(x=PC2, y=select.diffVarT))+ geom_point() + mytheme
ggplot(df.mod, aes(x=MycBin, y=select.diffVarT))+ geom_point() + mytheme
ggplot(df.mod, aes(x=mv_g.m2_logt, y=select.diffVarT))+ geom_point() + mytheme
#two-way
ggplot(df.mod, aes(x=PC1, y=select.diffVarT))+ geom_point() + mytheme + facet_grid(~MycBin)
ggplot(df.mod, aes(x=PC2, y=select.diffVarT))+ geom_point() + mytheme + facet_grid(~MycBin)
ggplot(df.mod, aes(x=PC1, y=select.diffVarT, size=mv_g.m2_logt))+ geom_point() + mytheme
ggplot(df.mod, aes(x=PC2, y=select.diffVarT, size=mv_g.m2_logt))+ geom_point() + mytheme
ggplot(df.mod, aes(x=mv_g.m2_logt, y=select.diffVarT))+ geom_point() + mytheme + facet_grid(~MycBin)

paste('Differences in nitrification in 5-15cm depths are mediated by (a) PC2, (b)PC1:PC2, (c) PC1:PC2:Myc')
#one-way
ggplot(df.mod, aes(x=PC2, y=select.diffVarB))+ geom_point() + mytheme
#two-way
ggplot(df.mod, aes(x=PC1, y=select.diffVarT, size=PC2))+ geom_point() + mytheme + facet_grid(~MycBin)
...
write.table(result.mod[['summ']], file=paste(figuresPath,newfilename, sep='/'), sep='\t')
paste('Differences in ammonification in 0-5cm depths are not mediated by factors measured')
paste('Differences in ammonification in 5-15cm depths are mediated by (a) PC1, (b) Myc, (c) Mv, (d) PC1:PC2, (e) PC1:Myc, (f) PC1:Mv, (g) Myc:Mv, (h) PC1:PC2:Mv, (i) PC1:Myc:Mv')
#one-way
ggplot(df.mod, aes(x=PC1, y=select.diffVarB))+ geom_point() + mytheme
ggplot(df.mod, aes(x=MycBin, y=select.diffVarB))+ geom_point() + mytheme
ggplot(df.mod, aes(x=mv_g.m2_logt, y=select.diffVarB))+ geom_point() + mytheme
#two-way
ggplot(df.mod, aes(x=PC1, y=select.diffVarB, size=PC2))+ geom_point() + mytheme
ggplot(df.mod, aes(x=PC1, y=select.diffVarB))+ geom_point() + mytheme + facet_grid(~MycBin)
ggplot(df.mod, aes(x=PC1, y=select.diffVarB, size=mv_g.m2_logt))+ geom_point() + mytheme
ggplot(df.mod, aes(x=mv_g.m2_logt, y=select.diffVarB))+ geom_point() + mytheme + facet_grid(~MycBin)
...
write.table(result.mod[['summ']], file=paste(figuresPath,newfilename, sep='/'), sep='\t')
paste('Differences in mineralization in 0-5cm depths are not mediate by factors measured')
paste('Differences in mineralization in 5-15cm depths are mediate by all fixed effects and interactions')
#one-way
ggplot(df.mod, aes(x=PC1, y=select.diffVarB))+ geom_point() + mytheme
ggplot(df.mod, aes(x=PC2, y=select.diffVarB))+ geom_point() + mytheme
ggplot(df.mod, aes(x=MycBin, y=select.diffVarB))+ geom_point() + mytheme
...
ggplot(df.mod, aes(x=PC1, y=select.diffVarB, size=PC2))+ geom_point() + mytheme
ggplot(df.mod, aes(x=PC1, y=select.diffVarB))+ geom_point() + mytheme + facet_grid(~MycBin)
ggplot(df.mod, aes(x=PC2, y=select.diffVarB))+ geom_point() + mytheme + facet_grid(~MycBin)
ggplot(df.mod, aes(x=mv_g.m2_logt, y=select.diffVarB))+ geom_point() + mytheme + facet_grid(~MycBin)
